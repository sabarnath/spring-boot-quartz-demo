...
package com.kaviddiss.bootquartz.examples.example7;
...
public class InterruptExample {
  ...
  public static void run(Scheduler sched) throws Exception {
    ...
    JobDetail job = newJob(DumbInterruptableJob.class).withIdentity("interruptableJob1", "group5").build();

    SimpleTrigger trigger = newTrigger().withIdentity("trigger1", "group5").startAt(startTime)
