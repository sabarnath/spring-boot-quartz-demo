...
package com.kaviddiss.bootquartz.examples.example8;
...
public class CalendarExample {
  ...
  public static void run(Scheduler sched) throws Exception {
    ...
    JobDetail job = newJob(SimpleJob.class).withIdentity("job1", "group6").build();

    SimpleTrigger trigger = newTrigger().withIdentity("trigger1", "group6").startAt(runDate)
